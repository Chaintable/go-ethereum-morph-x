...
This repository is a **fork**: upstream [morph-l2/go-ethereum](https://github.com/morph-l2/go-ethereum)
...
a general-purpose fork of morph-l2/go-ethereum.
...
* Release tags follow `v<base-version>-ct.N` (`ct` = Chaintable; e.g.
  `v2.2.0-ct.3`); a GitHub Release publishes the versioned images
